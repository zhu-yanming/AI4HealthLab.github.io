...
//centerCanvas();
  ...
  // r1y = height * 0.15; // 根据页面高度动态设置内椭圆的y轴半径
  // r2x = width * 0.40; // 根据页面宽度动态设置外椭圆的x轴半径
  // r2y = height * 0.4; // 根据页面高度动态设置外椭圆的y轴半径

  sections = [
    { label: "Deep learning paradigms", color: '#C0504D', start: 0, end: 50, url: "1_research.html#c_paradigms" },
    { label: "Multimodal data integration", color: '#8064A2', start: 50, end: 130, url: "1_research.html#c_multimodal" },
    { label: "Trustworthy AI for healthcare", color: '#F79646', start: 130, end: 180, url: "1_research.html#c_trustAI" },
    { label: "Computational microscopy", color: '#9BBB59', start: 180, end: 230, url: "1_research.html#c_micro" },
    { label: "Computational histopathology", color: '#5A9BD3', start: 230, end: 310, url: "1_research.html#c_hist" },
    { label: "Computational neuroscience", color: '#4BACC6', start: 310, end: 360, url: "1_research.html#c_neru" }
  ];
